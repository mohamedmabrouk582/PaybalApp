 ...
 */
public class BaybalActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paybal);
    ...
    public void onBuyPressed(View pressed) {
     ...
     //   PayPalPayment thingToBuy = getStuffToBuy(PayPalPayment.PAYMENT_INTENT_SALE);
        ...
        Intent intent = new Intent(BaybalActivity.this, PaymentActivity.class);
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        return new PayPalPayment(new BigDecimal("10"), "USD", "iphone",
                paymentIntent);
    }
    ...
    private PayPalPayment getStuffToBuy(String paymentIntent) {
        ...
        Toast.makeText(this,it+"\n"+ paymentDetails.getShipping()+"\n"+paymentDetails.getSubtotal()+"\n"+
                paymentDetails.getTax()
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(BaybalActivity.this, PayPalFuturePaymentActivity.class);
    ...
    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(BaybalActivity.this, PayPalProfileSharingActivity.class);
